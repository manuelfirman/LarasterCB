...
class DemonBoss : public Enemigos
{
	private:
	...
	public:
		DemonBoss(float x, float y, sf::Texture& textura, std::map<std::string, sf::SoundBuffer>& sonidos, SpawnerEnemigos& tile_spawner, Entidades& jugador);
		virtual ~DemonBoss();
